  ...
  const handleChange = useCallback((e) => {
    ...
    setFormData((prev) => {
      ...
      localStorage.setItem(
        STORAGE_KEYS.MONTHLY_REPORT_DRAFT,
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            ...
            <div>
              ...
              <input
                id="boxes_export_customers"
                type="number"
                min="0"
                name="boxes_export_customers"
                value={formData.boxes_export_customers}
                onChange={handleChange}
                placeholder="0"
              />
            </div>
            <div>
              ...
              <input
                id="boxes_local_market"
                type="number"
                min="0"
                name="boxes_local_market"
                value={formData.boxes_local_market}
                onChange={handleChange}
                placeholder="0"
              />
            </div>
            <div>
              ...
              <input
                id="boxes_banana_meal"
                type="number"
                min="0"
                name="boxes_banana_meal"
                value={formData.boxes_banana_meal}
                onChange={handleChange}
                placeholder="0"
              />
            </div>
            <div>
              ...
              <input
                ...
                min="0"
                name="boxes_rejected"
                value={formData.boxes_rejected}
                onChange={handleChange}
                placeholder="0"
              />
            </div>
            <div>
              <label htmlFor="waste_boxes_supply_chain">
                Supply Chain Waste
              </label>
              <input
                id="waste_boxes_supply_chain"
                type="number"
                min="0"
                name="waste_boxes_supply_chain"
                value={formData.waste_boxes_supply_chain}
                onChange={handleChange}
                placeholder="0"
              />
            </div>
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            ...
            <div>
              ...
              <input
                id="pump_capacity_gpm"
                type="number"
                min="0"
                step="0.1"
                name="pump_capacity_gpm"
                value={formData.pump_capacity_gpm}
                onChange={handleChange}
                placeholder="0.0"
              />
            </div>
            <div>
              ...
              <input
                id="diesel_consumed_liters"
                type="number"
                min="0"
                step="0.1"
                name="diesel_consumed_liters"
                value={formData.diesel_consumed_liters}
                onChange={handleChange}
                placeholder="0.0"
              />
            </div>
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            <div>
              ...
              <input
                id="fertilizer_cost_ga"
                type="number"
                min="0"
                step="0.01"
                name="fertilizer_cost_ga"
                value={formData.fertilizer_cost_ga}
                onChange={handleChange}
                placeholder="0.00"
              />
            </div>
            <div>
              ...
              <input
                id="fertilizer_cost_gec"
                type="number"
                min="0"
                step="0.01"
                name="fertilizer_cost_gec"
                value={formData.fertilizer_cost_gec}
                onChange={handleChange}
                placeholder="0.00"
              />
            </div>
