  ...
  if (loading) {
    return (
      <div className="card">
        ...
        <div
          className="skeleton"
          style={{ height: "32px", width: "60%", marginBottom: "4px" }}
        ></div>
        <div
          className="skeleton"
    ...
    <div className="dashboard-content">
      ...
      <div className="data-grid" style={{ marginBottom: "64px" }}>
        <MetricCard
          ...
          value={
            latest.revenue_per_hectare
              ? latest.revenue_per_hectare.toLocaleString(undefined, {
        ...
        <MetricCard
          ...
          title="Water Usage"
          value={
            latest.water_usage_liters
              ? (latest.water_usage_liters / 1000).toFixed(0)
              : 0
          }
          unit="m³"
          label="Volume (Est.)"
            ...
            >
              ...
              <Tooltip
                contentStyle={{
                  borderRadius: "8px",
                  border: "none",
                  boxShadow: "0 13px 27px -5px rgba(50,50,93,.25)",
                }}
              />
              <Line
                yAxisId="left"
                type="monotone"
                dataKey="ghg_emissions_kg"
                stroke="#ef4444"
                strokeWidth={2}
                name="GHG (kg)"
              />
              ...
              {loading
                ...
                : metrics.map((row) => (
                    <tr key={row.id}>
                      ...
                      <td>
                        {(row.ghg_emissions_kg || 0).toLocaleString(undefined, {
                          maximumFractionDigits: 0,
                        })}
                      </td>
